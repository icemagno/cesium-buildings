...
var covers = require('./BboxLib').covers;
var initProj4 = require('./initializeProj4');
var WorkerPool = require('./WorkerPool');

var Cesium = {};
Cesium.BoundingSphere = require('terriajs-cesium/Source/Core/BoundingSphere');
Cesium.Cartesian3 = require('terriajs-cesium/Source/Core/Cartesian3');
Cesium.Cartographic = require('terriajs-cesium/Source/Core/Cartographic');
...
Cesium.ComponentDatatype = require('terriajs-cesium/Source/Core/ComponentDatatype');
Cesium.defined = require('terriajs-cesium/Source/Core/defined');
Cesium.destroyObject = require('terriajs-cesium/Source/Core/destroyObject');
Cesium.DeveloperError = require('terriajs-cesium/Source/Core/DeveloperError');
Cesium.EllipsoidGeodesic = require('terriajs-cesium/Source/Core/EllipsoidGeodesic');
Cesium.Event = require('terriajs-cesium/Source/Core/Event');
Cesium.GeographicTilingScheme = require('terriajs-cesium/Source/Core/GeographicTilingScheme');
Cesium.GeometryAttribute = require('terriajs-cesium/Source/Core/GeometryAttribute');
Cesium.GeometryAttributes = require('terriajs-cesium/Source/Core/GeometryAttributes');
Cesium.GeometryInstance = require('terriajs-cesium/Source/Core/GeometryInstance');
Cesium.Geometry = require('terriajs-cesium/Source/Core/Geometry');
Cesium.GeometryPipeline = require('terriajs-cesium/Source/Core/GeometryPipeline');
Cesium.loadXML = require('terriajs-cesium/Source/Core/loadXML');
Cesium.MaterialAppearance = require('terriajs-cesium/Source/Scene/MaterialAppearance');
Cesium.Material = require('terriajs-cesium/Source/Scene/Material');
Cesium.Matrix3 = require('terriajs-cesium/Source/Core/Matrix3');
Cesium.Matrix4 = require('terriajs-cesium/Source/Core/Matrix4');
Cesium.PolylineGlowMaterialProperty = require('terriajs-cesium/Source/DataSources/PolylineGlowMaterialProperty');
Cesium.PrimitiveCollection = require('terriajs-cesium/Source/Scene/PrimitiveCollection');
Cesium.Primitive = require('terriajs-cesium/Source/Scene/Primitive');
Cesium.PrimitiveType = require('terriajs-cesium/Source/Core/PrimitiveType');
Cesium.QuadtreeTileLoadState = require('terriajs-cesium/Source/Scene/QuadtreeTileLoadState');
Cesium.Rectangle = require('terriajs-cesium/Source/Core/Rectangle');
Cesium.RuntimeError = require('terriajs-cesium/Source/Core/RuntimeError');
Cesium.SceneMode = require('terriajs-cesium/Source/Scene/SceneMode');
...
var WfsTileProvider = function(options){
    ...
    var workerScript =  Cesium.defined(options.workerDir) ? options.workerDir+'/createWfsGeometry.js' : 'build/createWfsGeometry.js';
    console.log('workerScript', workerScript);
    this._workerPool = new WorkerPool(1, workerScript);
    ...
    console.log("WfsTileProvider built");
};
...
WfsTileProvider.prototype._getCapapilitesAndGetReady = function(){
    ...
    //    var maxExtent = new Cesium.Cartographic(extent.east, extent.north);
        ...
        that._tilePending = 0;
        that._ready = true;
        console.log("WfsTileProvider READY!");
...
module.exports = WfsTileProvider;
