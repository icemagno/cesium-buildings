...
var Cesium = {};
Cesium.BoundingSphere = require('cesium/Source/Core/BoundingSphere');
Cesium.Cartesian3 = require('cesium/Source/Core/Cartesian3');
Cesium.Cartographic = require('cesium/Source/Core/Cartographic');
...
Cesium.ComponentDatatype = require('cesium/Source/Core/ComponentDatatype');
Cesium.defined = require('cesium/Source/Core/defined');
Cesium.destroyObject = require('cesium/Source/Core/destroyObject');
Cesium.DeveloperError = require('cesium/Source/Core/DeveloperError');
Cesium.EllipsoidGeodesic = require('cesium/Source/Core/EllipsoidGeodesic');
Cesium.Event = require('cesium/Source/Core/Event');
Cesium.GeographicTilingScheme = require('cesium/Source/Core/GeographicTilingScheme');
Cesium.GeometryAttribute = require('cesium/Source/Core/GeometryAttribute');
Cesium.GeometryAttributes = require('cesium/Source/Core/GeometryAttributes');
Cesium.GeometryInstance = require('cesium/Source/Core/GeometryInstance');
Cesium.Geometry = require('cesium/Source/Core/Geometry');
Cesium.GeometryPipeline = require('cesium/Source/Core/GeometryPipeline');
Cesium.loadXML = require('cesium/Source/Core/loadXML');
Cesium.MaterialAppearance = require('cesium/Source/Scene/MaterialAppearance');
Cesium.Material = require('cesium/Source/Scene/Material');
Cesium.Matrix3 = require('cesium/Source/Core/Matrix3');
Cesium.Matrix4 = require('cesium/Source/Core/Matrix4');
Cesium.PolylineGlowMaterialProperty = require('cesium/Source/DataSources/PolylineGlowMaterialProperty');
Cesium.PrimitiveCollection = require('cesium/Source/Scene/PrimitiveCollection');
Cesium.Primitive = require('cesium/Source/Scene/Primitive');
Cesium.PrimitiveType = require('cesium/Source/Core/PrimitiveType');
Cesium.QuadtreeTileLoadState = require('cesium/Source/Scene/QuadtreeTileLoadState');
Cesium.Rectangle = require('cesium/Source/Core/Rectangle');
Cesium.RuntimeError = require('cesium/Source/Core/RuntimeError');
Cesium.SceneMode = require('cesium/Source/Scene/SceneMode');
...
WfsTileProvider.prototype._getCapapilitesAndGetReady = function(){
    ...
    //    var maxExtent = new Cesium.Cartographic(extent.east, extent.north);
        ...
        that._workerPool = new WorkerPool(4, 'build/createWfsGeometry.js');
        that._loadedBoxes = [];
