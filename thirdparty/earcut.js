...
function cureLocalIntersections(data, start, triangles, dim) {
    ...
    do {
        ...
        // a self-intersection where edge (v[i-1],v[i]) intersects2 (v[i+1],v[i+2])
        if (a.i !== b.i && intersects2(data, a.i, node.i, node.next.i, b.i) &&
...
function isValidDiagonal(data, a, b) {
    return !intersects2Polygon(data, a, a.i, b.i) &&
           locallyInside(data, a, b) && locallyInside(data, b, a) &&
...
function intersects2(data, p1, q1, p2, q2) {
    return orient(data, p1, q1, p2) !== orient(data, p1, q1, q2) &&
           orient(data, p2, q2, p1) !== orient(data, p2, q2, q1);
}

// check if a polygon diagonal intersects2 any polygon segments
function intersects2Polygon(data, start, a, b) {
    var node = start;
    do {
        var p1 = node.i,
            p2 = node.next.i;

        if (p1 !== a && p2 !== a && p1 !== b && p2 !== b && intersects2(data, p1, p2, a, b)) return true;
